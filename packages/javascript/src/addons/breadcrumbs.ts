...
/**
 * Browser-specific hint passed to beforeBreadcrumb callback.
 * Extends generic {@link BreadcrumbHint} with concrete browser event types.
 */
...
/**
 * @deprecated Use {@link BrowserBreadcrumbStore} instead.
 * Kept for backward compatibility while catcher.ts is being migrated.
 */
export { BrowserBreadcrumbStore as BreadcrumbManager };
