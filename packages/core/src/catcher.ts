...
import { BreadcrumbsMessageProcessor } from './messages/breadcrumbs-message-processor';
 ...
 * When provided, {@link BreadcrumbsMessageProcessor} is registered automatically
 * and breadcrumbs snapshot is captured into every outgoing event.
 *
...
export abstract class BaseCatcher<T extends ErrorsCatcherType> {
   ...
   * @param breadcrumbStore - optional breadcrumb store; registers {@link BreadcrumbsMessageProcessor} when provided
   */
